...
use App\Services\LaporanPanenService;

class LaporanPanenController extends BaseApiController
{
    public function index(): void
    {
        $currentUser = $GLOBALS['auth_user'];
        $filters = Request::all();
        $result = LaporanPanenService::listForCurrentUser($currentUser, $filters);
    ...
    public function store(): void
    {
        ...
        if ($action === 'submit') {
            $result = LaporanPanenService::createAndSubmit((int) $currentUser['id'], $input, $ip, $userAgent);
        } else {
            $result = LaporanPanenService::createDraft((int) $currentUser['id'], $input, $ip, $userAgent);
        }
    ...
    public function show(array $params): void
    {
        $currentUser = $GLOBALS['auth_user'];
        $id = (int) ($params['id'] ?? 0);
        $result = LaporanPanenService::getDetailForCurrentUser($id, $currentUser);
    ...
    public function update(array $params): void
    {
        ...
        $ip = Request::ip();
        $userAgent = Request::userAgent();
        $result = LaporanPanenService::updateDraft($id, (int) $currentUser['id'], $input, $ip, $userAgent);
    ...
    public function destroy(array $params): void
    {
        ...
        $ip = Request::ip();
        $userAgent = Request::userAgent();
        $result = LaporanPanenService::deleteDraft($id, (int) $currentUser['id'], $ip, $userAgent);
    ...
    public function submit(array $params): void
    {
        ...
        $ip = Request::ip();
        $userAgent = Request::userAgent();
        $result = LaporanPanenService::submitDraft($id, (int) $currentUser['id'], $input, $ip, $userAgent);
    ...
    public function verify(array $params): void
    {
        ...
        $result = LaporanPanenService::verify($id, (int) $currentUser['id'], $catatan, $ip, $userAgent);
    ...
    public function reject(array $params): void
    {
        ...
        $alasan = $input['alasan'] ?? '';
        $result = LaporanPanenService::reject($id, (int) $currentUser['id'], $alasan, $ip, $userAgent);
    ...
    public function archive(array $params): void
    {
        ...
        $catatan = $input['catatan'] ?? null;
        $result = LaporanPanenService::archive($id, (int) $currentUser['id'], $catatan, $ip, $userAgent);
    ...
    public function resubmit(array $params): void
    {
        ...
        $result = LaporanPanenService::resubmit($id, (int) $currentUser['id'], $input, $ip, $userAgent);
    ...
    public function uploadFoto(array $params): void
    {
        ...
        $destDir = $uploadRoot . '/assets/uploads/laporan-panen';
        ...
        try {
            ...
            $result = SecureImageUploader::validateAndStore($file, [
                ...
                'relative_base' => 'assets/uploads/laporan-panen',
            ]);
            ...
            LaporanPanen::update($id, ['foto_url' => $result['foto_url']]);
            ActivityLog::log((int) $currentUser['id'], 'laporan_panen_photo_uploaded', 'laporan_panen', $id, 'Foto laporan panen diupload: ' . $result['foto_url'], Request::ip(), Request::userAgent());
    ...
    public function deleteFoto(array $params): void
    {
        ...
        LaporanPanen::update($id, ['foto_url' => null]);
        ActivityLog::log((int) $currentUser['id'], 'laporan_panen_photo_deleted', 'laporan_panen', $id, 'Foto laporan panen dihapus', Request::ip(), Request::userAgent());
