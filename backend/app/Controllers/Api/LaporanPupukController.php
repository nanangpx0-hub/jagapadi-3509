...
use App\Services\LaporanPupukService;

class LaporanPupukController extends BaseApiController
{
    public function index(): void
    {
        $currentUser = $GLOBALS['auth_user'];
        $filters = Request::all();
        $result = LaporanPupukService::listForCurrentUser($currentUser, $filters);
    ...
    public function store(): void
    {
        ...
        if ($action === 'submit') {
            $result = LaporanPupukService::createAndSubmit((int) $currentUser['id'], $input, $ip, $userAgent);
        } else {
            $result = LaporanPupukService::createDraft((int) $currentUser['id'], $input, $ip, $userAgent);
        }
    ...
    public function show(array $params): void
    {
        $currentUser = $GLOBALS['auth_user'];
        $id = (int) ($params['id'] ?? 0);
        $result = LaporanPupukService::getDetailForCurrentUser($id, $currentUser);
    ...
    public function update(array $params): void
    {
        ...
        $ip = Request::ip();
        $userAgent = Request::userAgent();
        $result = LaporanPupukService::updateDraft($id, (int) $currentUser['id'], $input, $ip, $userAgent);
    ...
    public function destroy(array $params): void
    {
        ...
        $ip = Request::ip();
        $userAgent = Request::userAgent();
        $result = LaporanPupukService::deleteDraft($id, (int) $currentUser['id'], $ip, $userAgent);
    ...
    public function submit(array $params): void
    {
        ...
        $ip = Request::ip();
        $userAgent = Request::userAgent();
        $result = LaporanPupukService::submitDraft($id, (int) $currentUser['id'], $input, $ip, $userAgent);
    ...
    public function verify(array $params): void
    {
        ...
        $result = LaporanPupukService::verify($id, (int) $currentUser['id'], $catatan, $ip, $userAgent);
    ...
    public function reject(array $params): void
    {
        ...
        $alasan = $input['alasan'] ?? '';
        $result = LaporanPupukService::reject($id, (int) $currentUser['id'], $alasan, $ip, $userAgent);
    ...
    public function archive(array $params): void
    {
        ...
        $catatan = $input['catatan'] ?? null;
        $result = LaporanPupukService::archive($id, (int) $currentUser['id'], $catatan, $ip, $userAgent);
    ...
    public function resubmit(array $params): void
    {
        ...
        $result = LaporanPupukService::resubmit($id, (int) $currentUser['id'], $input, $ip, $userAgent);
    ...
    public function uploadFoto(array $params): void
    {
        ...
        $destDir = $uploadRoot . '/assets/uploads/laporan-pupuk';
        ...
        try {
            ...
            $result = SecureImageUploader::validateAndStore($file, [
                ...
                'relative_base' => 'assets/uploads/laporan-pupuk',
            ]);
            ...
            LaporanPupuk::update($id, ['foto_url' => $result['foto_url']]);
            ActivityLog::log((int) $currentUser['id'], 'laporan_pupuk_photo_uploaded', 'laporan_pupuk', $id, 'Foto laporan pupuk diupload: ' . $result['foto_url'], Request::ip(), Request::userAgent());
    ...
    public function deleteFoto(array $params): void
    {
        ...
        LaporanPupuk::update($id, ['foto_url' => null]);
        ActivityLog::log((int) $currentUser['id'], 'laporan_pupuk_photo_deleted', 'laporan_pupuk', $id, 'Foto laporan pupuk dihapus', Request::ip(), Request::userAgent());
