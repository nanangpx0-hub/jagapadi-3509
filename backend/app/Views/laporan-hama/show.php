...
<div class="detail-card">
    ...
    <div class="detail-grid">
        ...
        <div class="detail-item">
            ...
            <div class="value"><?= \App\Core\Security::e($laporan['nama_opt'] ?? '-') ?></div>
        </div>
        <div class="detail-item">
        ...
        <div class="detail-item">
            ...
            <div class="value"><?= \App\Core\Security::e($laporan['tingkat_keparahan'] ?? '-') ?></div>
        </div>
        <div class="detail-item">
            <div class="label">Luas Serangan (Ha)</div>
            <div class="value"><?= $laporan['luas_serangan'] !== null ? \App\Core\Security::e((string) $laporan['luas_serangan']) : '-' ?></div>
        </div>
        <div class="detail-item">
            <div class="label">Populasi</div>
            <div class="value"><?= $laporan['populasi'] !== null ? \App\Core\Security::e((string) $laporan['populasi']) : '-' ?></div>
        </div>
        <div class="detail-item">
        ...
        <div class="detail-item">
            ...
            <div class="value"><?= \App\Core\Security::e($laporan['lokasi'] ?? '-') ?></div>
        </div>
        <div class="detail-item">
        ...
        <div class="detail-full">
            ...
            <div class="value" style="font-weight:400;"><?= \App\Core\Security::e($laporan['alamat_lengkap'] ?? '-') ?></div>
        </div>
    ...
    <div class="action-group">
        ...
        <?php if ($laporan['status'] === 'Draf' && $currentUser['role'] === 'petugas' && (int) $laporan['user_id'] === (int) $currentUser['id']): ?>
            ...
            <form method="POST" action="/laporan-hama/<?= (int) $laporan['id'] ?>/delete" style="display:inline" onsubmit="return confirm('Hapus draf ini?')">
                <?= \App\Core\Security::csrfField() ?>
        ...
        <?php if ($laporan['status'] === 'Submitted' && $currentUser['role'] === 'admin'): ?>
            <form method="POST" action="/laporan-hama/<?= (int) $laporan['id'] ?>/verifikasi" style="display:inline">
                <?= \App\Core\Security::csrfField() ?>
            ...
            <div id="tolak-form-<?= (int) $laporan['id'] ?>" style="display:none;margin-top:8px;width:100%;">
                <form method="POST" action="/laporan-hama/<?= (int) $laporan['id'] ?>/tolak" style="display:flex;gap:8px;align-items:flex-start;">
                    <?= \App\Core\Security::csrfField() ?>
