...
<div class="form-card">
    ...
    <form method="POST" action="/laporan-hama" enctype="multipart/form-data" id="laporanHamaCreateForm">
            ...
            <div class="form-group">
                ...
                <select id="master_opt_id" name="master_opt_id">
                    ...
                    <?php foreach ($optList as $o): ?>
                        <option value="<?= (int) $o['id'] ?>" <?= ($oldInput['master_opt_id'] ?? '') == $o['id'] ? 'selected' : '' ?>><?= \App\Core\Security::e($o['nama_opt']) ?> (<?= \App\Core\Security::e($o['jenis']) ?>)</option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="inline-group">
            <div class="form-group">
                ...
                <select id="tingkat_keparahan" name="tingkat_keparahan">
                    ...
                    <option value="Ringan" <?= ($oldInput['tingkat_keparahan'] ?? '') === 'Ringan' ? 'selected' : '' ?>>Ringan</option>
                    <option value="Sedang" <?= ($oldInput['tingkat_keparahan'] ?? '') === 'Sedang' ? 'selected' : '' ?>>Sedang</option>
                    <option value="Berat" <?= ($oldInput['tingkat_keparahan'] ?? '') === 'Berat' ? 'selected' : '' ?>>Berat</option>
                </select>
            ...
            <div class="form-group">
                ...
                <input type="number" id="luas_serangan" name="luas_serangan" step="0.01" min="0" max="9999.99" value="<?= \App\Core\Security::e($oldInput['luas_serangan'] ?? '') ?>">
            ...
            <div class="form-group">
                ...
                <input type="number" id="populasi" name="populasi" step="0.01" min="0" value="<?= \App\Core\Security::e($oldInput['populasi'] ?? '') ?>">
        ...
        <div class="form-group">
            ...
            <input type="text" id="lokasi" name="lokasi" maxlength="255" value="<?= \App\Core\Security::e($oldInput['lokasi'] ?? '') ?>">
        ...
        <div class="inline-group">
            <div class="form-group">
                ...
                <input type="text" id="latitude" name="latitude" placeholder="-8.1734" value="<?= \App\Core\Security::e($oldInput['latitude'] ?? '') ?>">
                <?php if (!empty($errors['latitude'])): ?><div class="error"><?= \App\Core\Security::e($errors['latitude']) ?></div><?php endif; ?>
            </div>
            <div class="form-group">
                <label for="longitude">Longitude</label>
                <input type="text" id="longitude" name="longitude" placeholder="113.7012" value="<?= \App\Core\Security::e($oldInput['longitude'] ?? '') ?>">
        ...
        <div class="form-group">
            ...
            <textarea id="alamat_lengkap" name="alamat_lengkap" rows="2" maxlength="300"><?= \App\Core\Security::e($oldInput['alamat_lengkap'] ?? '') ?></textarea>
