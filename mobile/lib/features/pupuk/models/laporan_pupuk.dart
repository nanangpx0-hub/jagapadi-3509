class LaporanPupuk {
  ...
  final double? dosisPerHa;
  final double? luasPemupukan;
  final String? metodeAplikasi;
  ...
  factory LaporanPupuk.fromJson(Map<String, dynamic> j) {
    ...
    return LaporanPupuk(
      ...
      jenisPupuk: data['jenis_pupuk'] as String?,
      dosisPerHa: data['dosis_per_ha'] != null ? double.tryParse(data['dosis_per_ha'].toString()) : null,
      luasPemupukan: data['luas_pemupukan'] != null ? double.tryParse(data['luas_pemupukan'].toString()) : null,
      metodeAplikasi: data['metode_aplikasi'] as String?,
