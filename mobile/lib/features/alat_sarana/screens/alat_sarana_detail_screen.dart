...
class AlatSaranaDetailScreen extends StatefulWidget {
  final int id;
  const AlatSaranaDetailScreen({super.key, required this.id});

  @override
  State<AlatSaranaDetailScreen> createState() => _AlatSaranaDetailScreenState();
}

class _AlatSaranaDetailScreenState extends State<AlatSaranaDetailScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
        (_) => context.read<LaporanAlatSaranaProvider>().loadDetail(widget.id));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l?.nomorLaporan ?? 'Detail Laporan Alat & Sarana'),
        actions: [
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (l.namaAlat != null) _InfoRow('Nama Alat', l.namaAlat!),
                              if (l.jenisSarana != null) _InfoRow('Jenis Sarana', l.jenisSarana!),
                              if (l.kondisi != null) _InfoRow('Kondisi', l.kondisi!),
                              if (l.kapasitas != null) _InfoRow('Kapasitas', l.kapasitas!),
                              if (l.tahunPengadaan != null) _InfoRow('Tahun Pengadaan', l.tahunPengadaan!.toString()),
                            ...
                            children: [
                              Expanded(
                                child: OutlinedButton.icon(
                                  onPressed: () => context.push('/alat-sarana/${widget.id}/edit').then((_) => p.loadDetail(widget.id)),
