...
class IrigasiDetailScreen extends StatefulWidget {
  final int id;
  const IrigasiDetailScreen({super.key, required this.id});

  @override
  State<IrigasiDetailScreen> createState() => _IrigasiDetailScreenState();
}

class _IrigasiDetailScreenState extends State<IrigasiDetailScreen> {
