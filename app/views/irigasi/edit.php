...
<div class="container-fluid">
    ...
    <form action="<?= BASE_URL ?>irigasi/edit/<?= (int) $data['id'] ?>" method="POST" enctype="multipart/form-data" id="formIrigasi" class="needs-validation" novalidate>
                ...
                <div class="card card-outline card-success shadow-sm mb-4">
                    <div class="card-header">
                        <h3 class="card-title text-warning font-weight-bold">
                            <i class="fas fa-edit mr-2"></i> Edit Data Irigasi
                        </h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="border rounded p-2 bg-light text-center">
                                <img src="<?= htmlspecialchars(BASE_URL . (string) $data['foto_url']) ?>" alt="Current Photo" class="img-fluid rounded" style="max-height:200px;">
                            </div>
                        </div>
                        <?php endif; ?>
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="foto" name="foto" accept="image/jpeg,image/png,image/webp">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body p-0">
                        <button type="submit" class="btn btn-warning btn-lg btn-block mb-2 font-weight-bold py-3" id="btnSubmit">
                            <i class="fas fa-save mr-2"></i> UPDATE DATA IRIGASI
                        </button>
                        <a href="<?= BASE_URL ?>irigasi" class="btn btn-secondary btn-block">
