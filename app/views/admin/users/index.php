...
<!-- DataTables Assets -->
<link rel="stylesheet" href="<?= BASE_URL ?>public/vendor/css/dataTables-1.13.6.min.css">
<link rel="stylesheet" href="<?= BASE_URL ?>public/vendor/css/buttons.dataTables.min.css">
<script src="<?= BASE_URL ?>public/vendor/js/dataTables-1.13.6.min.js"></script>
<script src="<?= BASE_URL ?>public/vendor/js/dataTables.buttons.min.js"></script>
<script src="<?= BASE_URL ?>public/vendor/js/buttons.html5.min.js"></script>
<script src="<?= BASE_URL ?>public/vendor/js/jszip.min.js"></script>
...
document.addEventListener('DOMContentLoaded', function() {
    $('#users-table').DataTable({
        ...
        language: {
            url: '<?= BASE_URL ?>public/vendor/datatables/id-1.13.6.json'
        },
        columnDefs: [
