...
class Kabupaten extends Model {
    ...
    public function getAllWithPagination($search = '', $limit = 20, $offset = 0, $orderBy = 'kode_kabupaten', $orderDir = 'asc') {
        try {
            ...
            error_log('Kabupaten::getAllWithPagination - ' . $e->getMessage());
            return [];
        }
    }
    ...
    public function count($search = '') {
        try {
            ...
            error_log('Kabupaten::count - ' . $e->getMessage());
            return 0;
        }
    }
    ...
    public function checkKodeExists($kode, $excludeId = null) {
        try {
            ...
            error_log('Kabupaten::checkKodeExists - ' . $e->getMessage());
            return false;
        }
    }
    ...
    public function create($data) {
        try {
            ...
            error_log('Kabupaten::create - ' . $e->getMessage());
            return false;
        }
    }
    ...
    public function update($id, $data) {
        try {
            ...
            error_log('Kabupaten::update - ' . $e->getMessage());
            return 0;
        }
    }
    ...
    public function softDelete($id, $userId) {
        try {
            ...
            error_log('Kabupaten::softDelete - ' . $e->getMessage());
            return 0;
        }
    }
    ...
    public function findById($id) {
        try {
            ...
            error_log('Kabupaten::findById - ' . $e->getMessage());
            return null;
        }
    }
}
